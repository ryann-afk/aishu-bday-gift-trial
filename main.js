...
`;
    ...
    */
    ...
    unlockSecret.addEventListener("click", () => {
        ...
        <h2>❤️ Access Granted ❤️</h2>

       

        <p>
        You found the pic I hid from everyone else.
        </p>

        <p>
        this could be uss, maybe in another universe 🫠
        </p>
    ...
    const emotionalQuotes = [
        ...
        "happy birthday aishuuu ❤️",
        "Shundari kutty appi ittarno? 😌✨",
        "aa pallu Kanich angg chirikk muthee 😏❤️",
        "madhura 17 😏✨",
        "Mission: Make Aishu Smile  😭❤️",
    ...
    function startMemoryCounters() {

        if (countersStarted) return;

        countersStarted = true;

        animateCount("photoCount", 35);
        animateCount("voiceCount", 14);
        animateCount("cinemaCount", 12);
        animateCount("heartCount", 1);
